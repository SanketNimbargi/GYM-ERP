...
function McTabMenu(k) {
	var a = "length", j = function(e) {
		...
		a[g] = a[g][f](c, "$1");
		a[g] = a[g][f](/ $/, "")
	}, b, r, c, C = document, o = "createElement", s = "getElementById", P = [
			"$1$2$3", "$1$2$3", "$1$24", "$1$23", "$1$22" ], i = function(a, b) {
	...
	A.prototype = {
		...
		g : function(p) {
			for (var m = -1, n = -1, v, u, t = b.g > -1 && b.g < w[a] - 1, o = /www\.|#.*$/, r = d("location").href
					.toLowerCase()[f](o, "")[f](/([\-\[\].$()*+?])/g, "\\$1")
					+ "$", s = new RegExp(r, "i"), l, w = j(p), h = i(p, "a"), c = 0; c < h[a]; c++) {
				if (h[c].href) {
			...
			if (m == -1 && !k.strictUrlMatch) {
				r = d("location").href.toLowerCase()[f](o, "")[f](
						/([\-\[\].$()*+])/g, "\\$1")[f](/([?&])([^?&]+)/g,
						"($1$2)?")[f](/\(\?/g, "(\\?");
				s = new RegExp(r, "i");
				for (c = 0; c < h[a]; c++)
			...
			(new Function(
					...
					.apply(this, [ b, h[m], B, O, D, M, d, P, p, q ]).p = p
		},
		i : function() {
