...
<script type="text/javascript">
	$("#document").ready(function(){
		...
		$("#EnquiryByOneDateReport").validate({
			debug : true,
			rules : {
...
<body>
<s:form id="EnquiryByOneDateReport" name="EnquiryByOneDateReport" theme="css_xhtml">
<div>
<fieldset>
   <legend>Enquiry Details By Single Date</legend>
   <table>
     <tr>
   ...
   <tr>
    <td>
    <s:submit id="print" name="print" value="GetDetails" action="printenquiryDetailsByoneDate"></s:submit>
    <td>
   <tr>
    </table>
