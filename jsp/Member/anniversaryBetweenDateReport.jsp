...
<script type="text/javascript">
	$("#document").ready(function(){
		//Validation for form
		$("#anniversaryDetailsBetweenDate").validate({
			debug : true,
			rules : {
	...
	<s:form id="anniversaryDetailsBetweenDate" theme="css_xhtml">
		<div>
			<fieldset>
				<legend>Anniversary Details Between Date</legend>
				<table>
					<tr>
				...
				<s:submit id="print" value="GetDetails" align="center" action="anniversaryDetailsBetweenDateReport"/>
			</fieldset>
		</div>
	</s:form>