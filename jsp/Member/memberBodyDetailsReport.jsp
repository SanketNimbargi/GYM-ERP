		...
		$("#toDate").datepicker({
		 ...
		 $("#memberRegistrationDetails").validate({
			...
			rules : {
				...
				"membersNameAutocomplete":{required:true},
			},
			messages : {
				"fromDate":{required:"Enter Date From"},
				"toDate":{required:"Enter Date of To"},
				"membersNameAutocomplete":{required:"Select Member"},
			},
...
<!--************Start Body here********************************** -->
 ...
 <td colspan="2"><s:textfield id="membersNameAutocomplete" name="memberName" 
				...
				<s:submit id="print" value="print" action="MemberbodyDetailReport" align="center"/>
			</fieldset>
		</div>
	</s:form>