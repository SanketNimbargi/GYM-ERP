...
<script type="text/javascript">
	$("#document").ready(function(){
		...
		$("#EnquiryBetweenDateReport").validate({
			debug : true,
			rules : {
...
<body>
<s:form id="EnquiryBetweenDateReport" theme="css_xhtml">
<div>
<fieldset>
   <legend>Enquiry Details Between Date</legend>
   <table>
     <tr>
   ...
   <tr>
    <td>
    <s:submit id="print" name="print" value="GetDetails" action="printenquiryDetailsBetweenDate" cssClass="smallBtn"></s:submit>
    <td>
   <tr>
    </table>
