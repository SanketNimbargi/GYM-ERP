...
<!--************Start Body here********************************** -->
	...
	<s:form id="revenueForm" theme="css_xhtml">
		<div>
			<fieldset>
				<legend>Revenue Details Between Date</legend>
				<table>
					<tr>
				...
				<s:submit id="print" value="Print Details" action="printRevenueDetailsReport" align="center"/>
			</fieldset>
		</div>
	</s:form>