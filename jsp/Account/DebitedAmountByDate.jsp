...
<body>
<s:form id="DebitAmountByDate" theme="css_xhtml">
<div>
<fieldset>
   <legend>Debited Amount Details By Date</legend>
   <table>
     <tr>
   ...
   <tr>
    <td>
    <s:submit id="print" name="print" value="GetDetails" action="printDebitedAmountDetailsByDate" cssClass="smallBtn"></s:submit>
    <td>
   <tr>
    </table>
