...
<!-- Developed by: Pranjali Deshmukh
	 Date: 10/09/2014
	 Purpose: Personal Trainer Details By Date
-->
...
<script type="text/javascript">
	$("#document").ready(function(){
		//Validation for form
		$("#personaltrainerDetails").validate({
			debug : true,
			rules : {
	...
	<s:form id="personaltrainerDetails" theme="css_xhtml">
		<div>
			<fieldset>
				<legend>Personal Trainer Details Between Date</legend>
				<table>
					<tr>
				...
				<s:submit id="print" value="GetDetails" align="center" action="personaltrainerDetailsByDate"/>
			</fieldset>
		</div>
	</s:form>