...
<div class="navbar-inner" style="background:none;">
	...
	<div class="click_notification_header" id="1"> 
		<a href="#myPend" class="btn btn-lg btn-primary" data-toggle="modal" style="width:120px; margin:0;"><span class="required"><s:property value="%{pendingFeesList.size()}"/></span> Pending Fees</a>
	</div>
	 <div class="notification_header" id="2" style="width:120px;"> 
		<a href="#myRe" class="btn btn-lg btn-primary" data-toggle="modal" style="width:120px; margin:0;"><span class="required"><s:property value="%{(reNewBeforList.size())+(reNewAfterList.size())}" /></span> Re-New</a> 
	</div>
	<div class="notification_header" id="3">
		<a href="#myRec" class="btn btn-lg btn-primary" data-toggle="modal" style="width:120px; margin:0;"><span class="required"><s:property value="%{birthDayList.size()}" /></span> BirthDay Today</a>
	</div>
	<div class="notification_header" id="7" style="width:120px;">
		<a href="#myAnn" class="btn btn-lg btn-primary" data-toggle="modal" style="width:120px; margin:0;"><span class="required"><s:property value="%{birthDayList.size()}" /></span> Anniversary Today</a>
	</div>
	<div class="notification_header" id="4"> 
		<a href="#myAtt" class="btn btn-lg btn-primary" data-toggle="modal" style="width:120px; margin:0;"><span class="required"><s:property value="%{attendanceList.size()}" /></span> Attendance</a>
	</div>
	
	<div class="notification_header" id="5" style="width:120px;"> 
		<a href="#myModal" class="btn btn-lg btn-primary" data-toggle="modal" style="width:120px; margin:0;"><span class="required"><s:property value="%{appointmentList.size()}" /></span> Today Appointment</a>
	</div>
	
	<div class="notification_header" id="6" style="width:120px;"> 
		<a href="#myModal1" class="btn btn-lg btn-primary" data-toggle="modal" style="width:120px; margin:0;"><span class="required"><s:property value="%{enquirytList.size()}" /></span> Enquiry </a> 
	</div>
	...
	<div id="myPend" class="modal fade">
		...
		<s:form theme="css_xhtml">
			<s:if test="pendingFeesList.size() > 0">
				...
				<table>
					...
					<tr>
						<td colspan="3"><button type="button" class="btn btn-default" data-dismiss="modal" style="float:right;">Close</button></td>
					</tr>
				</table>
			</s:if>
		</s:form>
